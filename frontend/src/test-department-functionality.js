...
console.log('🚀 Starting Department Functionality Tests');
...
const testCreateDepartment = async () => {
  ...
  try {
    ...
    const departmentData = {
      ...
      managers: ["K6gW9I1aypYN9uTIW6cMGVBEB4o1"] // Using one of the manager IDs from Department.tsx
    };
...
const testUpdateDepartment = async (departmentId) => {
  ...
  try {
    ...
    const updateData = {
      ...
      managers: ["K6gW9I1aypYN9uTIW6cMGVBEB4o1", "tpNykUrXytMDFWrv8PxY3TBfr1k2"]
    };
...
// =============================================================================
// 2. EMPLOYEE MANAGEMENT OPERATIONS (from Department.tsx EmployeeModal)
// =============================================================================

// Test 6: Create Employee (from Department.tsx handleAddEmployee)
...
// Test 7: Get Department Employees
...
// =============================================================================
// 3. COMPREHENSIVE TEST WORKFLOW (matches Department.tsx functionality)
// =============================================================================

const runDepartmentFunctionalityTests = async () => {
  console.log('');
  ...
  try {
    ...
    if (createdDepartment) {
      testDepartmentId = createdDepartment.id;
    }
    console.log('');
    ...
    // Phase 3: Employee Management (matches Department.tsx EmployeeModal)
    console.log('📋 PHASE 3: Employee Management (matches Department.tsx EmployeeModal)');
    console.log('-'.repeat(60));
...
runDepartmentFunctionalityTests()
  .then(results => {
    console.log('');
