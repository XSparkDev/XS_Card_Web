// Department Comprehensive Test - Robust Version
...
console.log('🚀 Starting Department Comprehensive Tests - Robust Version');
...
const testGetAllDepartments = async () => {
  ...
  try {
    ...
    if (error.message.includes('timeout')) {
      console.error('   💡 This might indicate the server is not responding');
    }
    return [];
  }
};
...
// =============================================================================
// 2. EMPLOYEE MANAGEMENT (from Department_Management_UI_Testing_Guide.md)
// =============================================================================
